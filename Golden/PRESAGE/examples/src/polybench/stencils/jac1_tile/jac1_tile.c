...
if (n >= 4) {
  for (t1=0;t1<=floord(n-1,32);t1++) {
    for (t2=2*t1;t2<=min(floord(3*n-3,32),floord(64*t1+n+61,32));t2++) {
      ...
      for (t3=max(ceild(32*t2-n+2,2),32*t1);t3<=min(min(min(floord(32*t2-n+32,2),n-1),32*t1+31),16*t2-2);t3++) {
      ...
      for (t3=max(ceild(32*t2-n+33,2),32*t1);t3<=min(min(n-1,32*t1+31),16*t2-2);t3++) {
      ...
      if ((n >= 5) && (t1 == 0)) {
        for (t3=max(0,16*t2-1);t3<=min(floord(32*t2-n+32,2),n-1);t3++) {
          b[2] = 0.33333 * (a[2 -1] + a[2] + a[2 + 1]);;
      ...
      for (t3=max(max(ceild(32*t2-n+33,2),32*t1),16*t2-1);t3<=min(min(n-1,32*t1+31),16*t2+14);t3++) {
        b[2] = 0.33333 * (a[2 -1] + a[2] + a[2 + 1]);;
